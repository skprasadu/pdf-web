...
public class FileWorkspaceDAO implements WorkspaceDAO {
	...
	public void addTemplateFile(InputStream stream, String documentId, String filename) throws WorkspaceException {
		Path p = Paths.get(this.getDataDir(), "templates", documentId);
        ...
        try {
			Files.copy(stream, Paths.get(this.getDataDir(), "templates", documentId, filename), StandardCopyOption.REPLACE_EXISTING);
		} catch (IOException e) {
			throw new WorkspaceException(e);
		}
