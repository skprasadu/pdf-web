...
public class IndexRouteGroup implements RouteGroup {
    ...
    private static final String[] indexes = new String[]{"pdf/:file_id", "help", "about", "mytemplates"};
    ...
    public void addRoutes() {
        ...
        post("templates/upload.json", new UploadTemplateRoute(workspaceDAO), new JsonTransformer());
    }
}